...
const soContainer_1 = __webpack_require__(70);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(2);
const engineSelect_1 = __webpack_require__(71);
const InputSo = () => {
...
class EngineSelect extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
        return React.createElement("div", { className: "input-group" },
            React.createElement("input", { type: "text", className: "form-control inputbox", id: "txtKW", name: "q", autoComplete: "off", placeholder: "输入您要搜索的内容...", value: "", onChange: this.props.keyWordChange }),
            React.createElement("div", { className: "input-group-btn" },
                React.createElement("button", { type: "button", className: "btn btn-warning searchBtn ng-binding", id: "btnSearch", onClick: this.props.searchClick },
                ...
                React.createElement("ul", { className: "dropdown-menu dropdown-menu-right", role: "menu" }, this.props.engineList.map((v) => {
                    return React.createElement("li", { key: v.id },
                        React.createElement("a", { href: "javascript:void(0);", onClick: this.props.searchEngineChange.bind(this, v.id) },
                            React.createElement("span", { className: this.props.currentEngine == v ? "glyphicon glyphicon-ok" : "" }),
                            v.name));
                }))));
    }
}
...
const mapDispatch = (dispatch) => {
    return {
        ...
        searchEngineChange: (id) => dispatch(actions.changeEngine(id))
    };
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const actionTypes_1 = __webpack_require__(29);
exports.changeEngine = (id) => {
    return {
        type: actionTypes_1.default.ChangeEngineOption,
        currentEngineID: id
    };
};
exports.searchButtonClick = () => {
    return {
        type: actionTypes_1.default.SearchButtonClick
    };
};
exports.searchKeyWordsChange = () => {
    return {
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(21);
const reducer_1 = __webpack_require__(74);
const baseInfo = __webpack_require__(75);
const initStore = {
    engineList: [],
    currentEngine: null
};
...
const store = redux_1.createStore(reducer_1.default, initStore);
...
exports.default = (state, action) => {
    switch (action.type) {
        case actionTypes_1.default.ChangeEngineOption:
            ...
            state = Object.assign({}, state, { currentEngine: state.engineList.find(k => k.id == id) });
            break;
